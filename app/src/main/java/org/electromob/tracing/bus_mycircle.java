...
public class bus_mycircle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_mycircle);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("Bus_Circle").child("Circlemembers");
        ...
        adapter = new MembersAdapter1(namelist,getApplicationContext());
