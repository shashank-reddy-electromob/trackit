...
public class MembersAdapter1 extends RecyclerView.Adapter<MembersAdapter.MembersViewHolder>
{
    ...
    MembersAdapter1(ArrayList<createuser> namelist, Context c)
    {
    ...
    public MembersAdapter.MembersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MembersAdapter.MembersViewHolder membersViewHolder = new MembersAdapter.MembersViewHolder(v,c,namelist);
